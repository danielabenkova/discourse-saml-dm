...
class ::DiscourseSaml::SamlOmniauthStrategy < OmniAuth::Strategies::SAML
  ...
  def render_auto_submitted_form(destination:, params:)
    submit_script_url = UrlHelper.absolute("https://czbrn-discourse.emea.thermo.com/plugins/discourse-saml/javascripts/submit-form-on-load.js", GlobalSetting.cdn_url)
